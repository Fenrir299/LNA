...
public sealed class MsWordDecoderOP2 : IContentDecoder
{
    private readonly ILogger<MsWordDecoderOP2> _log;

    public MsWordDecoderOP2(ILoggerFactory? loggerFactory = null)
    {
        this._log = (loggerFactory ?? DefaultLogger.Factory).CreateLogger<MsWordDecoderOP2>();
    }
